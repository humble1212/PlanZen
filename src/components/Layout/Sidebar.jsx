...
export default function Sidebar() {
  ...
  return (
    <nav className=" shadow-lg h-full fixed w-full p-2 flex flex-col items-start justify-center gap-4">
      <ul className="mt-2">
        <li>
          <NavLink
            to={"/Dashboard"}
            className=" hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
            <svg
      ...
      <div className="mt-6">
        <h6 className="text-blue-600 text-sm font-bold px-4">Features</h6>
        <ul className="mt-3">
          <li>
            <NavLink
              to={"/habits"}
      ...
      <div className="mt-6">
        <h6 className="text-blue-600 text-sm font-bold px-4">budget</h6>
        <ul className="mt-3">
          <li>
            <NavLink
              to={"/budget"}
      ...
      <div className="mt-6">
        <h6 className="text-blue-600 text-sm font-bold px-4">Settings</h6>
        <ul className="mt-3">
          <li>
            <NavLink
              to={"/settings"}
          ...
          <li>
            <button
              type="button"
              className=" hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all w-full"
          ...
          <li>
            <button
              type="button"
              className=" hover:text-blue-600 text-sm flex items-center justify-center gap-3 hover:bg-blue-50 rounded px-4 py-3 transition-all w-full"
              onClick={() =>
                themeMode === "light" ? darkTheme() : lightTheme()
              }>
              {themeMode === "light" ? (
                <MdLightMode className="text-blue-600 text-xl" />
              ) : (
